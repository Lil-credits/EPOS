...
FROM (SELECT Id FROM Teams WHERE Name IN ('Team Alpha', 'Team Beta')) AS team
       CROSS JOIN (SELECT Id FROM Users) AS usr;
...
-- Please replace the actual Ids accordingly if they differ.
