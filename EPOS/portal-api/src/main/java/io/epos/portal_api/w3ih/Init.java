package io.epos.portal_api.w3ih;
...
public class Init {
    public static void main(String[] args) {
        ...
        String mcTest = "{\n" +
                ...
                "    }\n" +
                "}";
        JsonObject json = (JsonObject) Json.decodeValue(mcTest);
        System.out.println(json);
        AchievementCredential achievementCredential = json.mapTo(AchievementCredential.class);
        System.out.println(achievementCredential);
        String jsonString = Json.encode(achievementCredential);
        System.out.println(jsonString);
        JsonObject json2 = (JsonObject) Json.decodeValue(jsonString);
        AchievementCredential achievementCredential2 = json2.mapTo(AchievementCredential.class);
        System.out.println(achievementCredential2);
